...
{
	SolidBuild* sweepObj = new SolidBuild();
	int input;
	cout << "---------------------------------------------------------------------------------------" << endl;
	cout << "please input: 1(single ring 1)	or	2(single ring)	or	3(multiple ring)" << endl;
	cout << "---------------------------------------------------------------------------------------" << endl;
	cin >> input;
	if (input == 1)	s = sweepObj->SolidSingleRing();
	else if (input == 2)	s = sweepObj->SolidSingleRingTwo();
	else if (input == 3) s = sweepObj->SolidMultiRing();
	else cout << "it's false, please try again!" << endl;
	...
	glutCreateWindow("Sweeping Object");
	InitGL();
